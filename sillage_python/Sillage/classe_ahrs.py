...
class AHRS:
	...
	def __init__(self,port, baudrate=115200):
		...
		self.__file_name = '/home/sillage1/sillage_python/Sillage/log/ahrs'+ str(self.id) + '_log_' + str(datetime.date.today())+ str(current_time)
		...
		self.f_handler_detec = logging.FileHandler('/home/sillage1/sillage_python/Sillage/log/detect_ahrs'+ str(self.id) + '_log_' + str(datetime.date.today())+ str(current_time) + '.log')
